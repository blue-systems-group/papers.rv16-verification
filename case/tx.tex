...
In order to control these three probabilities, we developed a new propagation
...
probabilities, no violation was reported. \shuvendu{How did you come up with these magic parameters? Could you have increased them further without affecting scalability?} This demonstrates our framework's
ability to tolerate sniffer imperfection instead of raising false alarms. \shuvendu{What about scalability?}
...
affect the difference between mutation and the DUT trace.  \shuvendu{I almost missed that mutation trace is the candidate trace that our tool comes up with to justfiy acceptance. The readers will miss it surely.} For all following
...
\shuvendu{Its always good idea to pick a row/point in the table/figure and explain it}
...
were actually transmitted to unstuck the state machine. \shuvendu{I don't understand this}
We note, however, this
trend is protocol specific and may be not be generally applicate to other
protocols.
Second, as the system loss probability increases \shuvendu{What is the system loss probability?}, the Jaccard distance increases
...
avoid raising false alarms. \shuvendu{What about scalability?}
...
\begin{itemize}
  \item \textbf{Sequence Number}\quad The DUT does not assign sequence number
    ...
    does not increase sequence number after certain packet, etc. \shuvendu{Are there multiple such bugs?}
...
$k$ values.
\shuvendu{Again, pick a point in two figures and say what the point/cdf represents.}
