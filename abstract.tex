\begin{abstract}
  ...
  Losses caused by wireless propagation mean that sniffers
  cannot perfectly reconstruct the actual DUT packet trace. As a result,
  ...
  protocol implementation. Beginning with the original protocol monitor state
  ...
  search algorithm for searching over all mutated traces, as well as  more
  ...
  accurately distinguish most implementation errors.
\end{abstract}
