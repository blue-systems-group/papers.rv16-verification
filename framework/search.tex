...
yield a solution if exists, thus is exhaustive.  Due to the NP-completeness of
the problem, we also propose several heuristics in next section to prune out
unlikely branches, which makes the algorithm meaningful in practice.
